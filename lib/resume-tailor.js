 ...
 */
async function tailorResumeForJob({ resumeMarkdown, jobDescription, additionalDetails, provider, model }) {
  ...
  // Default low reasoning effort for GPT-5 so visible resume text is not starved; disable with OPENAI_RESUME_REASONING_EFFORT=off
