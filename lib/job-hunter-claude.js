...
const JOB_HUNTER_CRM_TABLE_SPEC =
  ...
  '- **Yrs exp**: from the posting (e.g. `0–2`, `3+`, `Entry`). **Default when unknown:** `—`.\n' +
  '- **Job details**: 1–2 sentences (scope, stack, campaigns, fit). No pipe `|` characters. **Default when unknown:** `—`.\n' +
  '- **Location**: city/state or `Remote` / `Hybrid`. **Default when unknown:** `—`.\n' +
  '- **Deadline**: ISO date or `Rolling` if the posting says so. **Default when unknown:** `—` (not a guess).\n' +
